...
if not st.session_state['is_logged_in']:
    ...
    st.sidebar.markdown(f"""<a href="{ARIYADASA_URL}" target="_blank" style="text-decoration:none;"><div class="ad-card"><img src="{AD_IMAGE_URL}" style="width:100%; border-radius:8px;"><p style="color:#facc15; margin-top:10px;">G.H. Ariyadasa Book Shop</p></div></a>""", unsafe_allow_html=True)
    st.sidebar.markdown("---")
